export const profile = {
  ...
  focus: "Data, Metrics & Strategy Execution",
  email: "mercykendi501@gmail.com",
  phone: "+254 790 149 924",
  location: "Nairobi, Kenya",
  linkedin: "https://www.linkedin.com/in/mercykendi",
  github: "https://github.com/Ms-Kendi",
  resume: "/downloads/kendi-mercy-resume.pdf",
  headline: "I build practical operating systems that help organizations organize their data, measure what matters and turn strategy into execution.",
  introduction: "I support advisors, CEOs and teams with data organization, performance reporting, process design, communication systems, automation and responsible use of AI.",
};
...
export const caseStudies = [
  ...
  {
    id: "founders-factory", number: "02", organization: "Founders Factory Africa", status: "Proposed approach", title: "A repeatable multi-market data model",
    summary: "A proposed approach to consistent programme data across Kenya, Nigeria and South Africa.",
...
export const method = [
  { title: "Understand", description: "Clarify the objective, stakeholders, constraints and decisions the organization needs to make." },
  { title: "Map", description: "Make current processes, data sources, responsibilities, tools and decision points visible." },
  { title: "Prioritize", description: "Focus on the improvements that will create the most value without overwhelming the team." },
  { title: "Build", description: "Develop practical workflows, metrics, dashboards, templates, documentation and automation." },
  { title: "Embed", description: "Support adoption, review performance and improve the system based on real use." },
];
...
export const experience = [
  { role: "Program Manager — Professional Foundations", company: "ALX Africa", dates: "Jan 2025–Present", summary: "Lead multi-country programme operations serving 60,000+ participants annually, with a focus on programme health, performance reporting and strategic execution." },
...
export const tools = ["Microsoft Excel", "Google Sheets", "Google Workspace", "Microsoft Office", "Notion", "Airtable", "Asana", "Trello", "ClickUp", "Monday.com", "CRM & workflow platforms", "AI & LLM tools"];
