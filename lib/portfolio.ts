...
export const services = [
  ...
  { number: "03", title: "Communication & Alignment", description: "Create clear leadership updates, decision logs, action trackers and cross-functional routines so strategy remains connected to execution.", deliverable: "Shared context. Clear next steps.", tools: ["Google Workspace", "Microsoft Office", "Notion", "Decision & action logs"], icon: "communication" },
